...
This project is also split licensed like projects like DOOM or Quake. in other words, the repo you currently see is open source, but the assets (e.g., 3D models, audio files, 2D assets, etc.) are omitted.  
