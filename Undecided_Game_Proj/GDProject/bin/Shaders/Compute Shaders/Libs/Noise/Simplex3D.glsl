...
float simplex3D(vec3 inVector, const uint SEED){ // shitty. I don't know what I was doing while implementing this dog shit
    ...
    uvec3 flooredVec = uvec3(floor(skewed_vec));
    ...
    uvec3 i3_offset = ivec3(1, 1, 1);
    
    uvec3 i0_cell = flooredVec;
    uvec3 i1_cell = flooredVec + i1_offset;
    uvec3 i2_cell = flooredVec + i2_offset;
    uvec3 i3_cell = flooredVec + i3_offset;
